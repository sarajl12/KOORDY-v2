...
public final class ItemMessageSentBinding implements ViewBinding {
  ...
  private ItemMessageSentBinding(@NonNull LinearLayout rootView, @NonNull TextView tvBubble,
  ...
  public static ItemMessageSentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMessageSentBinding((LinearLayout) rootView, tvBubble, tvTime);
    }
